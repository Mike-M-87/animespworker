...
<body>
  ...
  <section class="px-3 py-10 text-white flex min-h-svh h-full w-svw flex-col justify-center items-center">
    ...
    <div
      class="w-full max-w-3xl mt-5 bg-black bg-opacity-60 backdrop-blur-md border shadow-[5px_0_5px_5px] shadow-white/10 border-white/40 rounded-2xl">

      <div class="flex flex-col pt-7 px-5 sm:pt-10 sm:px-10">
      ...
      <div id="favsSection" class="flex pt-5 pb-7 px-5 sm:pb-10 sm:px-10 flex-col gap-4 sm:max-h-[67vh] max-h-[66vh] overflow-y-auto">
        ${favs}
      </div>
    </div>
